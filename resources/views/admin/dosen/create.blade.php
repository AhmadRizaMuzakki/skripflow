<x-app-layout>
    <x-slot name="header">
        <div>
            <h1 class="text-lg font-semibold text-slate-900">Tambah Dosen</h1>
            <p class="text-sm text-slate-500">Buat akun dosen pembimbing baru.</p>
        </div>
    </x-slot>
    ...
    <div class="mx-auto max-w-xl">
        <form method="POST" action="{{ route('admin.dosen.store') }}"
            ...
            <div class="mt-6 flex flex-wrap gap-3">
                <button type="submit" class="auth-btn w-auto px-6">Simpan Dosen</button>
